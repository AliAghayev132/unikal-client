...
export const Contact = () => {
        ...
        <div className="flex-1 flex flex-col gap-6 max-w-md">
          ...
          <div className="rounded-3xl border border-slate-200/60 bg-white/80 backdrop-blur-md p-8 shadow-md">
            ...
            <ul className="space-y-3 text-slate-700 text-sm md:text-base">
              ...
              <li className="flex items-center gap-3">
                <MapPin size={18} className="text-indigo-500" />Niyazi küçəsi, 121, Sumqayıt şəhəri, AZ5009
              </li>
            </ul>
          </div>
  ...
  <iframe
    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3038.847962250021!2d49.867092!3d40.409264!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x40307d8c8f7f4f61%3A0xa2c7e4d88a9c8f81!2sBaku!5e0!3m2!1sen!2saz!4v1691234567890"
    width="100%"
    height="300"
    style={{ border: 0 }}
